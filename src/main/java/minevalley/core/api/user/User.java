...
import minevalley.core.api.user.exceptions.UserNotOnlineException;
import minevalley.core.api.user.exceptions.UserNotPermittedException;
import minevalley.core.api.user.friends.FriendRequest;
import minevalley.core.api.user.friends.Friendship;
